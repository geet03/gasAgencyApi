...
export function fakeBackendFactory(backend:MockBackend,options:BaseRequestOptions,realBackend:XHRBackend){
    ...
    backend.connections.subscribe((connection: MockConnection) => {
        ...
        setTimeout(() => {
            ...
            // create employee
            if (connection.request.url.endsWith('/api/employee') && connection.request.method === RequestMethod.Post) {
                ...
                // get new user object from post body
                //let receivedEmp = JSON.parse(connection.request.getBody());
                //let newEmp = Object.assign({}, receivedEmp);
                //console.log('inside fake backend');
                //console.log(receivedEmp);
                //emp[emp.length]=newEmp;
               ...
               // emp.push(newEmp);
                ...
                // respond 200 OK
                //connection.mockRespond(new Response(new ResponseOptions({ status: 200, body: newEmp })));
